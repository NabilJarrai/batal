          ...
          `}>
            ...
            {onDelete && (
              <button
                ...
                className="px-3 py-2 bg-red-600/20 hover:bg-red-600/30 border border-red-600/30 rounded-lg text-red-300 text-sm font-medium transition-colors duration-200"
                title="Delete Player"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
