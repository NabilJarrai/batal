    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-accent-teal/5 via-white to-accent-yellow/5 rounded-2xl p-12 border border-gray-100 shadow-lg text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl text-text-secondary mb-8 leading-relaxed">
            Fuel your child's performance with personalized nutrition guidance designed specifically for young athletes
          </p>
          ...
          <p className="text-text-secondary max-w-2xl mx-auto">
            We're developing a comprehensive nutrition program that will help optimize your child's diet,
            boost their energy levels, and enhance their athletic performance.
          </p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-lg text-center hover:shadow-xl transition-all">
          ...
          <p className="text-text-secondary">
            Custom meal plans tailored to your child's training schedule, dietary preferences, and performance goals.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-lg text-center hover:shadow-xl transition-all">
          ...
          <p className="text-text-secondary">
            Optimize energy and recovery with specific nutrition guidance for before and after training.
          </p>
        </div>
      ...
      <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-lg">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-text-primary mb-4">For Parents</h3>
            <ul className="space-y-3 text-text-secondary">
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                Monitor your child's nutrition progress
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                Access meal planning tools and recipes
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                Receive nutritional education content
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                Get hydration tracking and reminders
              </li>
            </ul>
          </div>

          <div>
            <h3 className="text-lg font-semibold text-text-primary mb-4">For Young Athletes</h3>
            <ul className="space-y-3 text-text-secondary">
              <li className="flex items-start gap-3">
      ...
      <div className="bg-gradient-to-r from-primary/10 via-accent-teal/10 to-primary/10 rounded-2xl p-8 border border-gray-100 text-center">
        ...
        <p className="text-text-secondary mb-6 max-w-2xl mx-auto">
          ...
          Keep supporting your child's training and healthy eating habits in the meantime!
        </p>
