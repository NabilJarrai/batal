      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-cyan-700 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 flex justify-between items-start">
            <div>
              ...
              <p className="text-blue-200">Comprehensive academy oversight and analytics</p>
            </div>
            <div className="flex items-center space-x-4">
              <div className="text-right">
                <p className="text-sm text-blue-200">Welcome back,</p>
                <p className="text-white font-semibold">{user?.email || 'Manager'}</p>
              </div>
              <LogoutButton />
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6">
            ...
            <p className="text-blue-200 text-sm font-medium">Academy Status</p>
            <p className="text-2xl font-bold text-white">{stats.activePlayers} Active</p>
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-sm text-yellow-400 font-medium">+12%</span>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-sm text-purple-400 font-medium">{stats.totalCoaches + stats.totalAdmins}</span>
            </div>
            <p className="text-blue-200 text-sm font-medium">Total Staff</p>
            <p className="text-lg font-bold text-white">{stats.totalCoaches} Coaches</p>
            <p className="text-lg font-bold text-white">{stats.totalAdmins} Admins</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-sm text-cyan-400 font-medium">This Month</span>
            </div>
            <p className="text-blue-200 text-sm font-medium">Assessments</p>
            <p className="text-2xl font-bold text-white">{stats.completedAssessments} Done</p>
            <p className="text-xs text-blue-300 mt-1">
        ...
        <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6">
          {activeTab === 'overview' && (
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white/5 rounded-lg p-4">
                    <h3 className="text-lg font-medium text-white mb-3">Groups by Level</h3>
                    <div className="space-y-3">
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-1">
                          <span className="text-sm text-blue-200">Advanced</span>
                          <span className="text-sm font-medium text-white">
                  ...
                  {/* Groups by Age */}
                  <div className="bg-white/5 rounded-lg p-4">
                    <h3 className="text-lg font-medium text-white mb-3">Groups by Age Category</h3>
                    <div className="grid grid-cols-2 gap-3">
                      {Object.entries(groupsByAge).map(([age, count]) => (
                        <div key={age} className="bg-white/10 rounded-lg p-3">
              ...
              <div>
                <h3 className="text-lg font-medium text-white mb-3">Top Performing Groups</h3>
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <select
                  ...
                  className="px-3 py-2 bg-white/10 backdrop-blur-sm border border-white/20 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400"
                >
              ...
              <div className="bg-white/5 rounded-lg p-6 mb-6">
                <h3 className="text-lg font-medium text-white mb-4">Player Growth Trend</h3>
                <div className="h-64 flex items-end justify-between gap-2">
                  {playerGrowthData.labels.map((label, index) => (
                    <div key={label} className="flex-1 flex flex-col items-center">
                      ...
                      <p className="text-xs text-blue-200 mt-2">{label}</p>
                      <p className="text-xs font-medium text-white">{playerGrowthData.values[index]}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white/5 rounded-lg p-4">
                  <h4 className="text-sm font-medium text-blue-200 mb-2">Average Group Size</h4>
                  <p className="text-2xl font-bold text-white">
                    {groups.length > 0 ? Math.round(stats.totalPlayers / groups.length) : 0}
                  </p>
                  <p className="text-xs text-blue-300 mt-1">players per group</p>
                </div>

                <div className="bg-white/5 rounded-lg p-4">
                  <h4 className="text-sm font-medium text-blue-200 mb-2">Coach-Player Ratio</h4>
                  <p className="text-2xl font-bold text-white">
                    1:{stats.totalCoaches > 0 ? Math.round(stats.totalPlayers / stats.totalCoaches) : 0}
                  </p>
                  <p className="text-xs text-blue-300 mt-1">optimal ratio maintained</p>
                </div>

                <div className="bg-white/5 rounded-lg p-4">
                  <h4 className="text-sm font-medium text-blue-200 mb-2">Retention Rate</h4>
                  <p className="text-2xl font-bold text-white">94%</p>
                  <p className="text-xs text-green-300 mt-1">+2% from last month</p>
                </div>
              </div>
            </div>
          )}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <button className="bg-white/5 hover:bg-white/10 border border-white/20 rounded-lg p-6 text-left transition-colors duration-200">
                  ...
                  <span className="text-xs text-blue-300">Last generated: 2 days ago</span>
                </button>
                ...
                <button className="bg-white/5 hover:bg-white/10 border border-white/20 rounded-lg p-6 text-left transition-colors duration-200">
                  ...
                  <span className="text-xs text-blue-300">Last generated: 1 week ago</span>
                </button>
                ...
                <button className="bg-white/5 hover:bg-white/10 border border-white/20 rounded-lg p-6 text-left transition-colors duration-200">
                  ...
                  <span className="text-xs text-blue-300">Last generated: 3 days ago</span>
                </button>
                ...
                <button className="bg-white/5 hover:bg-white/10 border border-white/20 rounded-lg p-6 text-left transition-colors duration-200">
                  ...
                  <span className="text-xs text-blue-300">Generate monthly</span>
                </button>
              </div>
            </div>
          )}
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm text-blue-200">Membership Fees</span>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm text-blue-200">Equipment & Merchandise</span>
