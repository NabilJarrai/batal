...
export default function CoachDashboard() {
  ...
  const handleCreateAssessment = () => {
    ...
    console.log('Create assessment for group:', selectedGroup?.id);
  };
          ...
          {activeTab === 'assessments' && (
            <div>
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-white">Player Assessments</h2>
                <button
                  onClick={handleCreateAssessment}
                  className="px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 rounded-lg text-white font-medium transition-all duration-200"
                >
                  Create Assessment
                </button>
              </div>
              ...
              <div className="text-center py-12">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-300">Assessment feature coming soon</h3>
                <p className="mt-1 text-sm text-gray-400">
                  You'll be able to create and manage player assessments here.
                </p>
              </div>
            </div>
          )}
