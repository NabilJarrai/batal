  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        <div className="alert-error max-w-md w-full">
          <svg className="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" />
          </svg>
          <div>
            <h2 className="text-heading-4 mb-2">Error Loading Dashboard</h2>
            ...
            <div>
              ...
              {groupPlayers.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="mt-2 text-sm font-medium text-gray-900">No players in this group</h3>
                  <p className="mt-1 text-sm text-gray-600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <button className="flex items-center gap-3 p-3 bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/30 rounded-lg transition-colors duration-200">
                ...
                <div className="text-left">
                  <p className="text-sm font-medium text-gray-900">Schedule Practice</p>
                  <p className="text-xs text-gray-600">Set up training sessions</p>
                </div>
              </button>
              ...
              <button className="flex items-center gap-3 p-3 bg-green-500/20 hover:bg-green-500/30 border border-green-500/30 rounded-lg transition-colors duration-200">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-gray-600">Contact parents</p>
                </div>
              </button>
              ...
              <button className="flex items-center gap-3 p-3 bg-purple-500/20 hover:bg-purple-500/30 border border-purple-500/30 rounded-lg transition-colors duration-200">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-gray-600">Group progress reports</p>
                </div>
              </button>
            </div>
          </div>
