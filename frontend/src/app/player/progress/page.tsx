  ...
  return (
    <div className="space-y-6">
      ...
      {assessments.length === 1 && (
        <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20 text-center">
          <ArrowTrendingUpIcon className="h-16 w-16 text-yellow-400 mx-auto mb-4" />
          <h3 className="text-xl font-bold text-white mb-2">Need More Data</h3>
          <p className="text-blue-200">
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
          ...
          <div className="space-y-3">
            {assessments.slice(0, 5).map((assessment, index) => (
              <div key={assessment.id} className="flex items-center justify-between py-2 border-b border-white/10 last:border-0">
                <div className="flex items-center gap-3">
                  <CalendarIcon className="h-4 w-4 text-blue-400" />
                  <div>
                    <span className="text-white font-medium">{assessment.period}</span>
